...
android {
    // Copiato così com'è da github.com/doGior/doGiorsHadEnough: il codice usa `BuildConfig` e le
    // risorse del package originale, non quello di zeroTituli impostato alla radice.
